    ...
    <div>
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-center">
                <form v-on:submit.prevent="createGlass" class="my-5" style="background: #FAD7A0; width: 70rem;">
                    ...
                    <div class="text-start p-3">
                        ...
                        <div class="mb-3">
                            <button type="submit" class="btn btn-primary me-2">Create Glass</button>
...
export default {
    ...
    methods: {
        async createGlass() {
            try {
                await GlassesService.post(this.glass)
                this.$router.push({
                    name: 'glasses'
                })
            } catch (error) {
